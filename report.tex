...
Technology is one of the most valuable business sectors in the world. However, because of fierce competition in almost every niche, a large number of technology companies do not survive. This article discusses some of the important concepts that are important for the success of a technology business - the idea, market, distribution, protection and survival techniques. It investigates multiple facets in achieving or avoiding the same end result for each of the concepts through examples. Each section contains a summary of my thoughts and at end I tie the concepts together in a recommendation.
